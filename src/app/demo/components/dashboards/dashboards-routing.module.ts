...
@NgModule({
    imports: [RouterModule.forChild([
       ...
       // { path: 'dashboard-commerce', data: {breadcrumb: 'E-Commerce Dashboard'}, loadChildren: () => import('./ecommerce/ecommerce.dashboard.module').then(m => m.EcommerceDashboardModule) },
